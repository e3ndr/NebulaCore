		...
		Consumer<InventoryClickEvent> itemListener = new Consumer<InventoryClickEvent>() {
			...
			public void accept(InventoryClickEvent e) {
				...
				for (ItemStack i : window.inv.getContents()) {
					if ((i != null) && 
							!ChatColorConfiguration.itemEquals(i, XMaterial.BLACK_DYE) && 
							!ChatColorConfiguration.itemEquals(i, XMaterial.IRON_BARS) && 
							!ChatColorConfiguration.itemEquals(i, XMaterial.LIGHT_WEIGHTED_PRESSURE_PLATE) && 
							!ChatColorConfiguration.itemEquals(i, XMaterial.GLASS) && 
							!ChatColorConfiguration.itemEquals(i, XMaterial.IRON_INGOT)) {
